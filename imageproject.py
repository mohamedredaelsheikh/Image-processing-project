...
#  method adjust Brigtness and constrast  for image
def Brigthness_constrastadj(img):
...
#    plt.show()
    return  new_image
Brigthness_constrastadj(img)

#  method apply adabtive threshold and histogram equalization on the image
